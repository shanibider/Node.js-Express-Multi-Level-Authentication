...
// then add some options. What i want to get from this login- scope (profile and email).
...
// clientID and clientSecret are the credentials that we got from google cloud console.
passport.use(
  "google",
  new GoogleStrategy(
    {
